...
<aside
	...
	class="absolute md:static md:max-w-xs w-full flex flex-col divide-y bg-gray-100 border-r h-screen"
>
	<header class="py-2 px-2 md:px-6 flex items-center gap-2">
		<Search />
